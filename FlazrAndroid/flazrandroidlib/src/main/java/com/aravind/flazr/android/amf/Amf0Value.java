...
package com.aravind.flazr.android.amf;


import com.aravind.flazr.android.util.ValueToEnum;
...
import static com.aravind.flazr.android.amf.Amf0Value.Type.*;

public class Amf0Value {

    private static final Logger logger = LoggerFactory.getLogger(Amf0Value.class.getSimpleName());
